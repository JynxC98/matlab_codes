...
while true
    for itr_capital = 1:spaces 
        for itr_productivity = 1:nstates
            ...
            rhs = exp(productivity(itr_productivity)) * capital_grid(itr_capital) ^ theta ...
                    - (gamma/2) * (capital_grid-capital_grid(itr_capital)).^2 - p * (capital_grid-capital_grid(itr_capital)) + beta * ...
